...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] font-body flex flex-col items-center select-none antialiased" dir="rtl">
      <div className="w-full max-w-[480px] md:max-w-none min-h-screen bg-white shadow-xl md:shadow-none flex flex-col relative overflow-hidden ring-1 ring-slate-100 md:ring-0">
        ...
        <header className="h-16 md:h-20 px-4 md:px-12 flex items-center justify-between fixed top-0 w-full max-w-[480px] md:max-w-none md:left-0 bg-white z-50 border-b border-gray-100 shrink-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/register" className="h-[38px] md:h-[42px] px-4 md:px-6 rounded-xl border border-orange-100 md:border-none text-orange-500 md:text-white md:bg-orange-500 md:hover:bg-orange-600 font-black text-[11px] md:text-[13px] flex items-center gap-2 transition-all outline-none focus:outline-none bg-transparent md:shadow-lg md:shadow-orange-500/20 select-none active:scale-95">
        ...
        <main className="flex-1 overflow-y-auto overflow-x-hidden pt-16 md:pt-20 pb-0 scroll-smooth scrollbar-hide">
          <div className="md:grid md:grid-cols-2 md:gap-x-12 md:items-start md:max-w-6xl md:mx-auto md:w-full md:px-12 md:pt-10 md:pb-6">
          <div className="flex justify-center mt-6 px-4 md:col-start-2 md:row-start-1 md:justify-start md:px-0 md:mt-6">
          ...
          <section className="text-center px-6 mt-5 md:col-start-1 md:row-start-1 md:text-right md:px-0 md:mt-0 md:self-center">
            <h1 className="text-3xl md:text-5xl font-black text-slate-900 leading-[1.35] tracking-tight">
          ...
          <section className="text-center px-6 mt-4 md:col-start-2 md:row-start-2 md:text-right md:px-0 md:mt-2">
            <p className="text-[13px] md:text-base text-slate-500/90 leading-relaxed font-black px-4 md:px-0 max-w-sm md:max-w-md mx-auto md:mx-0">
              خدمات موثوقة، أسعار تنافسية، وسرعة في التنفيذ لنجاحك الرقمي مع جمهورك
            </p>
          </section>

          <section className="relative h-[250px] md:h-[340px] mt-1 md:mt-0 flex items-center justify-center overflow-visible md:col-start-1 md:row-start-2 md:row-span-3 md:self-start">
          ...
          <section className="px-5 mt-4 flex flex-col gap-3.5 pb-2 md:col-start-2 md:row-start-3 md:px-0 md:mt-4 md:flex-row">
          ...
          <section className="px-5 mt-8 mb-8 md:col-start-2 md:row-start-4 md:px-0 md:mt-4 md:mb-0">
          ...
          <section className="px-5 space-y-6 py-10 md:py-16 md:max-w-6xl md:mx-auto md:w-full md:px-12">
            <div className="text-center space-y-1">
              <div className="inline-flex items-center justify-center w-10 h-10 rounded-2xl bg-orange-50 text-orange-500 mb-2">
                <Star className="h-6 w-6" />
              </div>
              <h2 className="text-xl md:text-3xl font-black text-slate-900 tracking-tight">خدماتنا المميزة</h2>
          ...
          <section className="px-5 space-y-6 py-10 md:py-16 md:max-w-6xl md:mx-auto md:w-full md:px-12">
            <div className="text-center space-y-1">
              ...
              <h2 className="text-xl md:text-3xl font-black text-slate-900 tracking-tight">لماذا تختارنا؟</h2>
          ...
          <section className="px-5 space-y-8 py-12 md:py-16 bg-gray-50/30">
            <div className="text-center space-y-1">
              <div className="inline-flex items-center justify-center w-10 h-10 rounded-2xl bg-orange-50 text-orange-500 mb-2">
                <HelpCircle className="h-6 w-6" />
              </div>
              <h2 className="text-xl md:text-3xl font-black text-slate-900 tracking-tight">الأسئلة الشائعة</h2>
              <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none">كل ما تحتاج لمعرفته</p>
            </div>

            <Accordion type="single" collapsible className="w-full space-y-4 md:max-w-3xl md:mx-auto">
              {faqs.map((faq, i) => (
          ...
          <footer className="mt-8 md:mt-16 border-t border-slate-100 bg-white rounded-t-[3rem] md:rounded-none pt-8 md:pt-14 pb-10 px-6 md:px-12 font-tajawal">
            <div className="max-w-4xl md:max-w-6xl mx-auto space-y-10 md:space-y-0 md:flex md:flex-col">
              <div className="md:flex md:flex-row-reverse md:justify-between md:items-start md:gap-12 md:pb-10 space-y-10 md:space-y-0">
              <div className="flex flex-col items-center text-center space-y-4 md:items-end md:text-right md:max-w-md">
                <div className="flex items-center gap-2">
                  <Image src={headerLogoUrl} alt="جمهورك" width={38} height={38} className="object-contain" />
                  <span className="text-xl font-black text-slate-900">جمهورك</span>
                </div>
                <p className="text-xs text-slate-500 leading-relaxed font-bold max-w-xs mx-auto md:mx-0">
                  المنصة الأسرع والأرخص لخدمات التسويق الرقمي في الوطن العربي. جودة مضمونة ودعم فني على مدار الساعة.
                </p>
              </div>

              <div className="grid grid-cols-2 gap-8 max-w-xs mx-auto md:mx-0 md:gap-16">
                <div className="space-y-4">
                  <h4 className="text-xs font-black text-slate-900 flex items-center justify-center md:justify-start">
                    القانونية
                  </h4>
                  <ul className="space-y-2 text-[11px] font-black text-slate-400 text-center md:text-right">
              ...
              <div className="pt-8 border-t border-slate-50 flex flex-col items-center gap-4 text-center md:flex-row-reverse md:justify-between md:gap-0">
