    ...
    <div className="space-y-6 pb-24 text-right" dir="rtl">
      ...
      <div className="px-1 space-y-6">
        ...
        <Tabs defaultValue="bank" onValueChange={handleTabChange} className="w-full" dir="rtl">
          <div className="w-full px-1 overflow-x-auto scrollbar-hide flex items-center justify-start gap-2 mb-8 py-2">
            <TabsList className="bg-transparent h-auto p-0 flex items-center gap-2 border-none">
              <TabsTrigger value="bank" className="rounded-xl h-10 px-6 font-black text-xs flex items-center gap-2 border transition-none outline-none data-[state=active]:bg-orange-500 data-[state=active]:text-white bg-white text-gray-500 border-gray-100 flex-row-reverse shadow-none"><span>تحويل بنكي</span><Building2 className="h-4 w-4" /></TabsTrigger>
              <TabsTrigger value="voucher" className="rounded-xl h-10 px-6 font-black text-xs flex items-center gap-2 border transition-none outline-none data-[state=active]:bg-orange-500 data-[state=active]:text-white bg-white text-gray-500 border-gray-100 flex-row-reverse shadow-none"><span>تعبئة (Recharge)</span><Smartphone className="h-4 w-4" /></TabsTrigger>
              <TabsTrigger value="history" className="rounded-xl h-10 px-6 font-black text-xs flex items-center gap-2 border transition-none outline-none data-[state=active]:bg-orange-500 data-[state=active]:text-white bg-white text-gray-500 border-gray-100 flex-row-reverse shadow-none"><span>سجل العمليات</span><History className="h-4 w-4" /></TabsTrigger>
            </TabsList>
          </div>

          <TabsContent value="bank" className="space-y-8 mt-4 outline-none">
          ...
          <TabsContent value="voucher" className="space-y-8 mt-4 outline-none">
            <div className="grid grid-cols-2 gap-4 w-full">
          ...
          <TabsContent value="history" className="space-y-6 mt-4 outline-none">
            <div className="space-y-4">
